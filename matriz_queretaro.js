...
const MATRIZ_QUERETARO = {
    "1-2":  { km: 12,  tarifa: 12  * bKm_QRO },
    "1-3":  { km: 18,  tarifa: 18  * bKm_QRO },
    "1-4":  { km: 55,  tarifa: 55  * bKm_QRO },
    "1-5":  { km: 35,  tarifa: 35  * bKm_QRO },
    "1-6":  { km: 32,  tarifa: 32  * bKm_QRO },
    "1-7":  { km: 70,  tarifa: 70  * bKm_QRO },
    "1-8":  { km: 75,  tarifa: 75  * bKm_QRO },
    "1-9":  { km: 80,  tarifa: 80  * bKm_QRO },
    "1-10": { km: 95,  tarifa: 95  * bKm_QRO },
    "1-11": { km: 80,  tarifa: 80  * bKm_QRO },
    "1-12": { km: 110, tarifa: 110 * bKm_QRO },
    "1-13": { km: 165, tarifa: 165 * bKm_QRO },
    "1-14": { km: 175, tarifa: 175 * bKm_QRO },
    "1-15": { km: 185, tarifa: 185 * bKm_QRO },
    "1-16": { km: 210, tarifa: 210 * bKm_QRO },
