...
const MATRIZ_QUERETARO = {
    ...
    // --- San Juan del Rio (central) ---
    "4-401":{km:0, tarifa: 0 * bKm_EST1},  // La llave crucero
    "4-402":{km:0, tarifa: 0 * bKm_EST1},  // Imss san juan

    // --- Tequisquiapan ---
    "7-701":{km:0, tarifa: 0 * bKm_EST1},  // Bordo blanco
    "7-702":{km:0, tarifa: 0 * bKm_EST1},  // Cmla trinidad crucero
    "7-703":{km:0, tarifa: 0 * bKm_EST1},  // San nicolas
};
