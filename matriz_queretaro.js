...
const localidadesObj = {
    ...
    305: "La piedad crucero",
    4: "San Juan del Rio (central)",
    5: "Huimilpan",
    6: "Pedro Escobedo",
    7: "Tequisquiapan",
    8: "Ezequiel Montes",
    806: "Los Benitos crucero",
    807: "Lib. Cadereyta a Xilitla",
    9: "Central Cadereyta",
    10: "Colon",
    1007: "Agropark",
    1008: "Arkansas universidad",
...
const coordenadasLocalidades = {
    ...
    305: { lat: 20.5718174, lng: -100.25943 },
    ...
    806: { lat: 20.692119, lng: -99.9547257 },
    807: { lat: 20.6805628, lng: -99.9313094 },
    9: { lat: 20.7003, lng: -99.8129 },
    10: { lat: 20.7833, lng: -100.05 },
    1007: { lat: 20.6950767, lng: -100.00586 },
    1008: { lat: 20.6546092, lng: -100.0993149 },
    ...
    401: { lat: 20.4413189, lng: -99.9646727 },
    402: { lat: 20.3760514, lng: -99.9863614 },
    701: { lat: 20.4984403, lng: -99.9282909 },
    702: { lat: 20.4914928, lng: -99.9346028 },
    703: { lat: 20.4788943, lng: -99.9370218 },
...
const MATRIZ_QUERETARO = {
    ...
    "8-804":{km:0, tarifa: 0 * bKm_EST1},
    "8-805":{km:0, tarifa: 0 * bKm_EST1},
    "9-901":{km:0, tarifa: 0 * bKm_EST1},
    "4-401":{km:0, tarifa: 0 * bKm_EST1},
    "4-402":{km:0, tarifa: 0 * bKm_EST1},
    "7-701":{km:0, tarifa: 0 * bKm_EST1},
    "7-702":{km:0, tarifa: 0 * bKm_EST1},
    "7-703":{km:0, tarifa: 0 * bKm_EST1},

    // --- La Cañada (El Marques) ---
    "3-305":{km:0, tarifa: 0 * bKm_EST1},  // La piedad crucero

    // --- Ezequiel Montes ---
    "8-806":{km:0, tarifa: 0 * bKm_EST1},  // Los Benitos crucero
    "8-807":{km:0, tarifa: 0 * bKm_EST1},  // Lib. Cadereyta a Xilitla

    // --- Colon ---
    "10-1007":{km:0, tarifa: 0 * bKm_EST1},  // Agropark
    "10-1008":{km:0, tarifa: 0 * bKm_EST1},  // Arkansas universidad
};
